...
/// for. Ported from `deepsight-altair-software`'s `eda::Port`, where this is a
/// preprocessor `#define` of the same name and value.
#define MAX_PORT_CALLBACKS 48
...
/// honest.
///
/// Ported from `deepsight-altair-software`'s `eda::Port`: every port
